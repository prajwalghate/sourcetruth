...
library Cast { function toInt(uint256 x) internal pure returns (int256) { return int256(x); } }
...
contract Token is ERC20, Both {
    ...
    function calc(uint256 a, uint256 b) external returns (int256) { return (a + b).toInt(); }
